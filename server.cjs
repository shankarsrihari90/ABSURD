...
http.createServer((request, response) => {
  ...
  const routes = {'/':'index.html','/index.html':'index.html','/calm-game.css':'calm-game.css','/calm-game.js':'calm-game.js','/make-it-absurd.css':'make-it-absurd.css','/make-it-absurd.js':'make-it-absurd.js','/absurd-version.js':'absurd-version.js','/absurd-dock.css':'absurd-dock.css','/absurd-dock.js':'absurd-dock.js'};
